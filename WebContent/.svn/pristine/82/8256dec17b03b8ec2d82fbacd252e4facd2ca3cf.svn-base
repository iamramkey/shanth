...
SignatureApp.controller('MasterFormController',
		function($rootScope, $scope, $http) {
			Main.log("Master Form Controller");
		});

SignatureApp.controller('MasterController', function($rootScope, $scope, $http,
		$timeout, $modal, $state) {
	...
	$scope.$on('$viewContentLoaded', function() {
		...
		Metronic.initAjax();
		$state.current.data.pageTitle = activePageCode;
	});
