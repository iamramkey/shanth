...
/* Metronic App */
var ThrazeApp = angular.module("ThrazeApp", [
    "ui.router", 
    "ui.bootstrap", 
    "oc.lazyLoad",  
    "ngSanitize"
...
ThrazeApp.config(['$ocLazyLoadProvider', function($ocLazyLoadProvider) {
...
ThrazeApp.config(['$controllerProvider', function($controllerProvider) {
  // this option might be handy for migrating old apps, but please don't use it
  // in new ones!
  $controllerProvider.allowGlobals();
}]);
...
ThrazeApp.factory('settings', ['$rootScope', function($rootScope) {
    // supported languages
    var settings = {
        layout: {
...
ThrazeApp.controller('HeaderController', ['$scope', function($scope) {
...
ThrazeApp.controller('SidebarController', ['$scope', function($scope) {
...
ThrazeApp.controller('FooterController', ['$scope', function($scope) {
    $scope.$on('$includeContentLoaded', function() {
...
ThrazeApp.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
...
ThrazeApp.run(["$rootScope", "settings", "$state", function($rootScope, settings, $state) {
    $rootScope.$state = $state; // state to be accessed from view
}]);
/* Setup App Main Controller */
ThrazeApp.controller('AppController', function($rootScope, $scope, $http) {
