...
function stockTransferCompleateModalSave() {
	if ( $ ( '#transferCharge00' ).val() == '' ) {
		alert ( 'Transfer Charge is a required field.' );
		return true;
	}
...
function poSendInfoModalSave() {
	...
	var dataForSendPO = {
		porId : porId,
		termsOfDelivery : prsTermsOfDelivery,
		email : prsEmail,
		subject : prsSubject,
		kindAttn : prsKindAttn,
		defaultPrint : prsDefaultPrint,
		sign : prsSign,
		supRef : prsSupRef,
		otherRef : prsOtherRef,
		despatchThrough : prsDespatchThrough
	};
