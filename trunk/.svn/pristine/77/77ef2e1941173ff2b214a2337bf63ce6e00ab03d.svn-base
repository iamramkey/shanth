...
@Path("/jobcapabilitystop")
public class JobCapabilityStopApi extends JobCapabilityStatusCommonApi
{
	...
	{
		return jobCapabilityChangeStatus(input, Constants.JOBTYPESTATUS_STOPPED);
	}
}
