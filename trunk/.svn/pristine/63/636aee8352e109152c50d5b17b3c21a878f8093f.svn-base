...
import se.signa.signature.dio.BDBVolumeAndRevenueDayChartResult;
...
@Path("/bdbvolumeandrevenuedaychart")
public class BDBVolumeAndRevenueDayChartApi extends StigWebApi
{
	private static Logger logger = Logger.getLogger(BDBVolumeAndRevenueDayChartApi.class);
	...
	public StigWebResult bdbVolumeAndRevenueChart(BusinessDashboardInput input)
	{
		...
		return new BDBVolumeAndRevenueDayChartResult(notification, categories, volumeSeriesList, revenueSeriesList);
	}
