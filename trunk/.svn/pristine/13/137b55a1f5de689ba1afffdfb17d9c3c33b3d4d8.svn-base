...
/* function fillProjectionlist(result){
	...
	for(var i = 0; i < result.projectionDataList.length; i++){
        if(result.projectionDataList[i].direction == 'IN')
        {
		      ...
		      inSeriesContent += '<div class="label label-sm label-info" style="background-color: green;"><i class="'+result.projectionDataList[i].icon+'"></i></div></div>';
		      inSeriesContent += '<div class="cont-col2"><div class="desc">'+result.projectionDataList[i].data;
	...
	for(var i = 0; i < result.projectionDataList.length; i++){
         if(result.projectionDataList[i].direction == 'OUT')
        {
		      ...
		      outSeriesContent += '<div class="label label-sm label-info"><i class="'+result.projectionDataList[i].icon+'"></i></div></div>';
		      outSeriesContent += '<div class="cont-col2"><div class="desc">'+result.projectionDataList[i].data;
	...
	// projectionListContainer
}
$(document).on('click','#Projectionlist_buttons',function(){
	if($('#Projectionlist_in').attr('checked')){
		$('#outSeriesContent').hide();
		$('#inSeriesContent').show();
	}
	if($('#Projectionlist_out').attr('checked')){
		$('#inSeriesContent').hide();
		$('#outSeriesContent').show();
	}
	if($('#Projectionlist_all').attr('checked')){
		$('#inSeriesContent').show();
		$('#outSeriesContent').show();
	}
}); */
